package br.com.futurodev.apispring.springfox;
...
public class SpringFoxConfig extends WebMvcConfigurationSupport {
    ...
    public Docket apiDocket(){
        return new Docket(DocumentationType.SWAGGER_2) // informa qual o tipo de documentação que vamos usar
                ...
                .apiInfo(metaData())
                .tags(new Tag("Clientes", "Gerencia clientes"),
                      new Tag("Produtos", "Gerencia produtos"),
                      new Tag("Formas de Pagamento", "Gerencia formas de pagamentos"),
                      new Tag("Itens do Pedido", "Gerencia pedidos"),
                      new Tag("Pedidos", "Gerencia pedidos"),
                      new Tag("Telefones", "Gerencia telefones"),
