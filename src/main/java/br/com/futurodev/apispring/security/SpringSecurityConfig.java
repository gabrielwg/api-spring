package br.com.futurodev.apispring.security;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                */
                ...
                .antMatchers("/clientes/**").hasRole("CADASTRADOR")
                .antMatchers("/pagamentos/**").hasRole("CADASTRADOR")
                .antMatchers("/itemPedidos/**").hasRole("CADASTRADOR")


                .antMatchers("/produtos/**").hasRole("PEDIDO")
                .antMatchers("/pedidos/**").hasRole("PEDIDO")
                .antMatchers("/clientes/**").hasRole("PEDIDO")
                .antMatchers("/pagamentos/**").hasRole("PEDIDO")
                .antMatchers("/itemPedidos/**").hasRole("PEDIDO")
